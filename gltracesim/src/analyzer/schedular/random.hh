#ifndef __GLTRACESIM_ANALYZER_SCHEDULAR_RANDOM_HH__
#define __GLTRACESIM_ANALYZER_SCHEDULAR_RANDOM_HH__
...
class RandomSchedular : public Schedular
{
...
public:
     ...
     * @brief Schedular
     */
    RandomSchedular(const Json::Value &params);

    /**
     * @brief ~Schedular
     */
    virtual ~RandomSchedular();
...
#endif // __GLTRACESIM_ANALYZER_SCHEDULAR_RANDOM_HH__
